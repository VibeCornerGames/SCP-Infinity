...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AUIWSWaterBody_Statics::NewProp_bDisableAutomaticInteraction_MetaData[] = {
		...
		{ "Comment", "/** Enable this to only support manual ripple creation.  Saves cost of rendering a scene capture each frame and drawing that to the interactivity which is too expensive on low end.  Overrides platform specific options.*/" },
		{ "ModuleRelativePath", "Public/UIWSWaterBody.h" },
		{ "ToolTip", "Enable this to only support manual ripple creation.  Saves cost of rendering a scene capture each frame and drawing that to the interactivity which is too expensive on low end.  Overrides platform specific options." },
	};
#endif
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AUIWSWaterBody_Statics::NewProp_bDisableAutomaticInteraction = { "bDisableAutomaticInteraction", nullptr, (EPropertyFlags)0x0010040000000005, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AUIWSWaterBody), &Z_Construct_UClass_AUIWSWaterBody_Statics::NewProp_bDisableAutomaticInteraction_SetBit, METADATA_PARAMS(Z_Construct_UClass_AUIWSWaterBody_Statics::NewProp_bDisableAutomaticInteraction_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AUIWSWaterBody_Statics::NewProp_bDisableAutomaticInteraction_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(AUIWSWaterBody, 3968477223);
