...
// End Cross Module References
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_ActivateOnReferenceViewer_MetaData[];
#endif
		static void NewProp_ActivateOnReferenceViewer_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_ActivateOnReferenceViewer;
		static const UE4CodeGen_Private::FClassPropertyParams NewProp_CustomGraphSchemas_Inner;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_CustomGraphSchemas_MetaData[];
#endif
		static const UE4CodeGen_Private::FArrayPropertyParams NewProp_CustomGraphSchemas;
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UElectronicNodesSettings_Statics::NewProp_ActivateOnReferenceViewer_MetaData[] = {
		{ "Category", "Activation|Schema" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UElectronicNodesSettings_Statics::NewProp_ActivateOnReferenceViewer = { "ActivateOnReferenceViewer", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UElectronicNodesSettings), &Z_Construct_UClass_UElectronicNodesSettings_Statics::NewProp_ActivateOnReferenceViewer_SetBit, METADATA_PARAMS(Z_Construct_UClass_UElectronicNodesSettings_Statics::NewProp_ActivateOnReferenceViewer_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UElectronicNodesSettings_Statics::NewProp_ActivateOnReferenceViewer_MetaData)) };
	const UE4CodeGen_Private::FClassPropertyParams Z_Construct_UClass_UElectronicNodesSettings_Statics::NewProp_CustomGraphSchemas_Inner = { "CustomGraphSchemas", nullptr, (EPropertyFlags)0x0004000000004000, UE4CodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UEdGraphSchema_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UElectronicNodesSettings_Statics::NewProp_CustomGraphSchemas_MetaData[] = {
		{ "Category", "Activation|Schema" },
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UElectronicNodesSettings_Statics::NewProp_CustomGraphSchemas = { "CustomGraphSchemas", nullptr, (EPropertyFlags)0x0014000000004001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UElectronicNodesSettings, CustomGraphSchemas), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UElectronicNodesSettings_Statics::NewProp_CustomGraphSchemas_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UElectronicNodesSettings_Statics::NewProp_CustomGraphSchemas_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UElectronicNodesSettings_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UElectronicNodesSettings_Statics::NewProp_ActivateOnReferenceViewer,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UElectronicNodesSettings_Statics::NewProp_CustomGraphSchemas_Inner,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UElectronicNodesSettings_Statics::NewProp_CustomGraphSchemas,
	...
	IMPLEMENT_CLASS(UElectronicNodesSettings, 2813486280);
