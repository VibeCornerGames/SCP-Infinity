...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAnimGraphNode_PowerIK_Ground_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "AnimGraphNode_PowerIK_Ground.h" },
		{ "ModuleRelativePath", "Public/AnimGraphNode_PowerIK_Ground.h" },
	};
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAnimGraphNode_PowerIK_Ground_Statics::NewProp_Node_MetaData[] = {
		{ "Category", "Settings" },
		{ "ModuleRelativePath", "Public/AnimGraphNode_PowerIK_Ground.h" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UAnimGraphNode_PowerIK_Ground_Statics::NewProp_Node = { "Node", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAnimGraphNode_PowerIK_Ground, Node), Z_Construct_UScriptStruct_FAnimNode_PowerIK_Ground, METADATA_PARAMS(Z_Construct_UClass_UAnimGraphNode_PowerIK_Ground_Statics::NewProp_Node_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAnimGraphNode_PowerIK_Ground_Statics::NewProp_Node_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAnimGraphNode_PowerIK_Ground_Statics::NewProp_bEnableDebugDraw_MetaData[] = {
		{ "Category", "Debug" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAnimGraphNode_PowerIK_Ground_Statics::NewProp_bEnableDebugDraw = { "bEnableDebugDraw", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UAnimGraphNode_PowerIK_Ground), &Z_Construct_UClass_UAnimGraphNode_PowerIK_Ground_Statics::NewProp_bEnableDebugDraw_SetBit, METADATA_PARAMS(Z_Construct_UClass_UAnimGraphNode_PowerIK_Ground_Statics::NewProp_bEnableDebugDraw_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAnimGraphNode_PowerIK_Ground_Statics::NewProp_bEnableDebugDraw_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UAnimGraphNode_PowerIK_Ground_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAnimGraphNode_PowerIK_Ground_Statics::NewProp_Node,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAnimGraphNode_PowerIK_Ground_Statics::NewProp_bEnableDebugDraw,
	};
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UAnimGraphNode_PowerIK_Ground_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_UAnimGraphNode_PowerIK_Ground()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UAnimGraphNode_PowerIK_Ground_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UAnimGraphNode_PowerIK_Ground, 717473589);
	template<> POWERIKTOOL_API UClass* StaticClass<UAnimGraphNode_PowerIK_Ground>()
	{
		return UAnimGraphNode_PowerIK_Ground::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UAnimGraphNode_PowerIK_Ground(Z_Construct_UClass_UAnimGraphNode_PowerIK_Ground, &UAnimGraphNode_PowerIK_Ground::StaticClass, TEXT("/Script/PowerIKTool"), TEXT("UAnimGraphNode_PowerIK_Ground"), false, nullptr, nullptr, nullptr);
